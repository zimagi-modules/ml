    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='model_relation', to='environment.environment')),
            ],
            options={
                'verbose_name': 'model',
                'verbose_name_plural': 'models',
                'db_table': 'model_manager_model',
                'ordering': ['name'],
                'abstract': False,
